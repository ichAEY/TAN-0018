...
export default {
  ...
  master: {
    ...
    aboutLead: "Я Светлана — эксперт по маникюру, педикюру и подологии.",
    aboutParagraphs: [],
    skills: [],
  },
  ...
  i18n: {
    ...
    translations: {
      en: {
        ...
        "Я Светлана — эксперт по маникюру, педикюру и подологии.": "I am Svetlana — a manicure, pedicure and podology expert.",
